...
class RequestAuthorizationTestCase(TestCase):
    ...
    def request(self, data, token=None):
        ...
        request = self.factory.post(
            "/v1/request-authorization/", data, **authorization_header
        )
...
class RepositoryAuthorizationRequestsTestCase(TestCase):
    ...
    def request(self, data, token=None):
        ...
        request = self.factory.get(
            "/v1/authorization-requests/", data, **authorization_header
        )
...
class ReviewAuthorizationRequestTestCase(TestCase):
    ...
    def request_approve(self, ra, token=None):
        ...
        response = ReviewAuthorizationRequestViewSet.as_view({"put": "update"})(
            request, pk=ra.pk
        )
        response.render()
        content_data = json.loads(response.content)
    ...
    def request_reject(self, ra, token=None):
        ...
        request = self.factory.delete(
            "/v1/review-authorization-request/{}/".format(ra.pk), **authorization_header
        )
        response = ReviewAuthorizationRequestViewSet.as_view({"delete": "destroy"})(
            request, pk=ra.pk
        )
        response.render()
        return response
