...
from .repository.views import RepositoryGroupPermissionsViewSet
from .repository.views import RepositoryPermissionsViewSet
...
router.register("repository/permissions", RepositoryPermissionsViewSet)
router.register(
