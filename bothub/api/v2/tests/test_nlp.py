...
class TrainStartTrainingTestCase(TestCase):
    ...
    def request(self, token):
        ...
        request = self.factory.post(
            ...
            json.dumps(
                {
                    'update_id': self.repository_update.pk,
...
class TrainGetEntitiesTestCase(TestCase):
    def setUp(self):
        ...
        RepositoryExampleEntity.objects.create(
            repository_example=self.repository_examples,
            start=11,
            end=18,
            entity='name'
        )
...
class AuthorizationInfoTestCase(TestCase):
    ...
    def request(self, token):
        ...
        request = self.factory.get(
            '/v2/repository/nlp/authorization/info/{}/'.format(
                token
            ),
            **authorization_header
        )
