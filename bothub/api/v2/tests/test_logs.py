...
from bothub.common.models import Repository, RepositoryAuthorization, RepositoryNLPLog, RepositoryNLPLogIntent
...
class RepositoryNLPLogTestCase(TestCase):
    ...
    def request(self, data):
        request = self.factory.post(
            "/v2/repository/nlp/log/",
            json.dumps(data),
            content_type="application/json"
        )
        response = RepositoryNLPLogsViewSet.as_view({"post": "create"})(
            request
        )
        response.render()
    ...
    def test_okay(self):
        ...
        self.assertEqual(data.get('repository_version'), content_data.get('repository_version'))
...
class ListRepositoryNLPLogTestCase(TestCase):
    ...
    def request(self, data, token=None):
        ...
        request = self.factory.get(
            "/v2/repository/log/", data, **authorization_header
        )
