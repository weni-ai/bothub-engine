    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository_version_language', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='repository_reports', to='common.RepositoryVersionLanguage')),
