...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='common.Repository'),
        ),
        migrations.AddField(
            model_name='repositoryevaluate',
            name='repository_version_language',
            field=models.ForeignKey(default=None, editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='added_evaluate', to='common.RepositoryVersionLanguage'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='repositoryevaluateresult',
            name='repository_version_language',
            field=models.ForeignKey(default=None, editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='results', to='common.RepositoryVersionLanguage'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='repositoryexample',
            name='repository_version_language',
            field=models.ForeignKey(default=None, editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='added', to='common.RepositoryVersionLanguage'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='repositorytranslatedexample',
            name='repository_version_language',
            field=models.ForeignKey(default=None, editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='translated_added', to='common.RepositoryVersionLanguage'),
            preserve_default=False,
        ),
    ]
