# Generated by Django 2.0.2 on 2018-02-23 01:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intent', models.CharField(blank=True, editable=False, max_length=64, verbose_name='intent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start', models.PositiveIntegerField(editable=False, verbose_name='start')),
                ('end', models.PositiveIntegerField(editable=False, verbose_name='end')),
                ('entity', models.CharField(editable=False, max_length=64, verbose_name='entity')),
        ...
        migrations.AddField(
            ...
            name='deleted_in',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='deleted', to='common.RepositoryUpdate'),
        ),
        migrations.AddField(
            model_name='repositoryexample',
            name='repository_update',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='added', to='common.RepositoryUpdate'),
        ),
    ]
