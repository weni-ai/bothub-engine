# Generated by Django 2.0.2 on 2018-03-06 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('BU', 'Business'), ('CO', 'Communication'), ('PR', 'Project'), ('ED', 'Education'), ('EN', 'Entertainment'), ('FI', 'Finance'), ('HE', 'Health'), ('ID', 'Identity')], max_length=2, verbose_name='category')),
