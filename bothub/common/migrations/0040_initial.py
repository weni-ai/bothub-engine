    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="When enabling name entities you will receive name of people, companies and places as results of your predictions.",
                        verbose_name="Use name entities",
                    ),
                ),
                (
                    "use_analyze_char",
                ...
                (
                    "total_updates",
                    models.IntegerField(default=0, verbose_name="total updates"),
                ),
                (
                    "nlp_server",
                    models.URLField(blank=True, null=True, verbose_name="Base URL NLP"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.CharField(
                        default="botinho", max_length=16, verbose_name="icon"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(help_text="Example text", verbose_name="text"),
                ),
                (
                    "intent",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(help_text="Translation text", verbose_name="text"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="created at"),
