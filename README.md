...
| Variable | Type | Default | Description |
|--|--|--|--|
| WEBAPP_REPO | ```string``` | ```https://github.com/Ilhasoft/bothub-webapp``` | Git repository URL. It will clone and run ```npm install && npm run build``` command on the entrypoint. This build is served by Nginx.
